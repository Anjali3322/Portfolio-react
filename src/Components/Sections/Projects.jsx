...
const Projects = () => {
  const projectsData = [
    ...
    },
    {
      ...
      desc: "A modern CRM dashboard designed for business management, customer analytics, and workflow tracking. Built a responsive and interactive frontend interface with clean data visualization, reusable UI components, and smooth user experience for sales and management teams.  ",
