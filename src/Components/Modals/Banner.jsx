...
const Banner = () => {
  ...
  <div className="relative z-[1] max-w-[700px]">
    <div className="inline-flex items-center gap-2 bg-[var(--accent-dim)] border border-[var(--border)] rounded-full py-[6px] px-4 text-[0.82rem] text-[var(--accent)] font-medium mb-7 animate-[fadeUp_0.6s_ease_both]"><span></span> Available for opportunities</div>
    <h1 className="font-[var(--font-head)] text-[clamp(2.8rem,6vw,5rem)] font-extrabold leading-[1.05] text-[var(--text)] animate-[fadeUp_0.6s_0.1s_ease_both]">Hi, I'm <span className="accent">Anjali</span> 👋</h1>
    <p className="font-[var(--font-head)] text-[clamp(1.3rem,2.5vw,1.8rem)] font-semibold text-[var(--muted)] mt-2 mb-5 animate-[fadeUp_0.6s_0.2s_ease_both]">Frontend Developer</p>
    <p className="text-[1.05rem] text-[var(--muted)] max-w-[480px] mb-10 animate-[fadeUp_0.6s_0.3s_ease_both]">I build clean and responsive web interfaces that users love to interact with.</p>
